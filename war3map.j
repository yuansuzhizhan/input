...
// Trigger: dialog
//===========================================================================
function Trig_dialogFunc011Func018Func019Conditions takes nothing returns nothing
...
function Trig_dialogFunc011Func018Conditions takes nothing returns nothing
    local trigger ydl_trigger
    if ( ( GetClickedButtonBJ() == udg_DHKbutton[1] ) ) then
        set udg_round=1
    else
    ...
    call TriggerAddCondition(ydl_trigger, Condition(function Trig_dialogFunc011Func018Func019Conditions))
    call FlushChildHashtable(YDHT, GetHandleId(GetTriggeringTrigger()))
    call DestroyTrigger(GetTriggeringTrigger())
    set ydl_trigger=null
endfunction
function Trig_dialogFunc011Conditions takes nothing returns nothing
    local trigger ydl_trigger
    if ( ( GetClickedButtonBJ() == udg_DHKbutton[1] ) ) then
        set udg_teamnb=2
    ...
    call TriggerAddCondition(ydl_trigger, Condition(function Trig_dialogFunc011Func018Conditions))
    call FlushChildHashtable(YDHT, GetHandleId(GetTriggeringTrigger()))
    call DestroyTrigger(GetTriggeringTrigger())
    set ydl_trigger=null
endfunction
function Trig_dialogActions takes nothing returns nothing
    ...
    call TriggerRegisterDialogEvent(ydl_trigger, udg_DHK)
    call TriggerAddCondition(ydl_trigger, Condition(function Trig_dialogFunc011Conditions))
...
call ExecuteFunc("jasshelper__initstructs33455194")
...
function jasshelper__initstructs33455194 takes nothing returns nothing
